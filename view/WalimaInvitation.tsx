...
export default function WalimaInvitation() {
  ...
  // Countdown timer (Walima date)
  useEffect(() => {
    const walimaDate = new Date("2026-03-25T20:00:00").getTime();

    const timer = setInterval(() => {
      const now = new Date().getTime();
      const distance = walimaDate - now;
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#F5F5DC]">
            ...
            <div className="text-center">
              ...
              >
                ...
                <div className="relative w-48 h-48 md:w-64 md:h-64">
                  {/* Main seal circle */}
                  <div
                    className="absolute inset-0 rounded-full bg-gradient-to-br from-[#F0E8D8] via-[#E8DCC0] to-[#D4C4A8] shadow-2xl"
                    style={{
                      boxShadow:
                        "0 20px 60px rgba(0,0,0,0.3), inset 0 -5px 15px rgba(0,0,0,0.2), inset 0 5px 15px rgba(255,255,255,0.5)",
                    }}
                  />

                  {/* Inner embossed circle */}
                  <div
                    className="absolute inset-6 md:inset-8 rounded-full border-4 border-[#C4B49A]/40"
                    style={{
      ...
      {/* Main Walima Invitation Content */}
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
          ...
          <div className="text-center z-10 px-4">
            ...
            >
              ...
              <p className="text-[#6E7A3D] text-sm md:text-base mb-6 tracking-wide">
                cordially invite you to the Walima reception of their beloved son
              </p>
              ...
              <div className="text-center space-y-4 md:space-y-5 relative z-10">
                ...
                <div className="mt-4 space-y-1">
                  ...
                  <p className="text-xs md:text-sm text-[#6E7A3D] tracking-wide">
                    request the honour of your presence at the Walima reception of
                    their son
                  </p>
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-[#6E7A3D] text-lg">
                Your presence will add joy to our Walima celebration
              </p>
            </div>
        ...
        <section
          ...
          style={{
            background:
              "linear-gradient(135deg, #7A8448 0%, #8B9556 50%, #9BA665 100%)",
          }}
        >
          <div
          ...
          <div className="text-center z-10 px-4 max-w-6xl mx-auto">
            <h2 className="font-serif text-5xl md:text-6xl text-white mb-4 italic">
              Countdown
            </h2>
            <p className="text-white/80 text-lg md:text-xl mb-16">
              To the Walima reception of Talha
            </p>
        ...
        <section className="py-20 px-4 bg-[#F5F5DC]">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-[#6E7A3D] text-lg">
                You are warmly invited to join us for the Walima reception
              </p>
            </div>
            ...
            <div className="max-w-md mx-auto">
              ...
              >
                ...
                <p className="text-[#6E7A3D] text-sm mb-3 text-center">8:00 PM</p>
                <p className="text-[#4A5228] text-sm font-semibold mb-1 text-center">
                  Venue:
                </p>
        ...
        <footer className="py-12 bg-[#4A5228] text-white text-center">
          ...
          <p className="text-lg font-serif italic mb-2">M Talha Yaseen</p>
          <p className="text-sm opacity-70">Walima — March 25, 2026</p>
